...
#input = "C 230 19/07/2015 04:35:51 IKV-5045 864244021994222,G 2930.02586 S 05441.69883 W 101.6 0.080 79.546,S 00 00 35 25 35 25 175 100 175 100 175 100 60,R 1 ED1F82 30 22 128,R 2 4B1082 32 21 0,R 3 A71682 32 19 0,R 6 0345D0 31 20 128,"
st = "C 230 19/07/2015 04:35:51 IKV-5045 864244021994222,G 2930.02586 S 05441.69883 W 101.6 0.080 79.546,S 00 00 35 25 35 25 175 100 175 100 175 100 60,R 1 ED1F82 30 22 128,R 2 4B1082 32 21 0,R 3 A71682 32 19 0,R 6 0345D0 31 20 128,"
...
if __name__ == '__main__':
    ...
    if crc != 0x988B:
        ...
        print ("expect:0xF5A5 but saw 0x%x") % crc
    else:
        print ("Ok")
        print (hex(crc))
    print ("test case #2:"),
    ...
    if crc != 0x988B:
        print ("BAD - ERROR - FAILED!"),
        print ("expect:00xF5A5 but saw 0x%x") % crc
    else:
        print ("Ok")
